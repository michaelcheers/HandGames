...
namespace LRCEngine
{
    public class JSONArray
    {
        ...
        public JSONTable getJSON(int idx)
        {
            ...
            _Dictionary
#endif
                <string, System.Object>)array[idx]);
        }
    ...
    public class JSONArray_JSONTables : JSONArrayEnumerator<JSONTable>
    {
        ...
        {
            get { return new JSONTable((
#if WINDOWS
            Dictionary
#else
            _Dictionary
#endif
                <string, System.Object>)baseEnumerator.Current); }
        }
    }
    ...
    public class JSONTable
    {
        ...
        Dictionary
            ...
            _Dictionary
#endif
        <string, System.Object> dictionary;
        ...
        public JSONTable(
            ...
            _Dictionary
#endif
            <string, System.Object> inDictionary)
        {
